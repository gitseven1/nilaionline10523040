...
?>
    ...
    <form enctype = "multipart/form-data" method="post">
        ...
        <tr>
            ...
            <td>
        <label>
        <input type="radio" name="jk" value="Laki-Laki" id="RadioGroupl_0" />
        Laki-Laki
        </label>
        <label>
        ...
        <td><label>
            <select name= "jurusan">
                ...
                <option valu="Teknik Informatika"> TEKNIK INFORMATIKA</option> 
                <option valus="Teknik Komputer">TEKNIK KOMPUTER</option>
            </select> </label><br /></td>
</tr>
        <tr>
        <td>PASSWORD</td>
