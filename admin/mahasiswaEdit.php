...
?>
    <form enctype="multipart/form-data" method="post">
        <table width="100%" border="0">
            ...
            <td> 
                <label> 
                    <input type="radio" name="jk" value="Laki-Laki" id="RadioGroup1_0" checked="checked"> Laki-Laki </label> 
                <label> <input type="radio" name="jk" value="Perempuan" id="RadioGroup1_1"> Perempuan </label>
            </td> 
        </tr> 
        <tr>
