...
<hr/><br/>
<a href="./?adm=matkulAdd"><input name="add" type="submit" class="buttonadm" value="TAMBAH DATA MATA KULIAH"/></a> 
<br> 
<br> 
...
<tr class="add"> 
    ...
    <td class="value">
        <a href="./?adm=matkulEdit&kode_matkul=<?php echo"$datamatkul[0]"; ?>">Edit</a> |
        <a href="./?adm=matkulDelete&kode_matkul=<?php echo"$datamatkul[0]"; ?>">Hapus</a>
